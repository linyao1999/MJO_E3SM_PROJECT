...
for case_dir in ['control', 'FIX_QRT', 'GBL_QRT']:
            ...
            for Tlow in [90, 100, 110, 150]:
                for Thig in [10, 20, 30]:
                    ...
                    for key in comp.keys():
                        tmp = (comp['mse'] * comp[key]).mean(dim=['lon', 'lat'])  # domain average
    ...
    plt.savefig('./plots/'+case_dir+'/VR_develop_3terms.pdf', bbox_inches='tight')
    ...
    plt.savefig('./plots/'+case_dir+'/VR_propagation_3terms.pdf', bbox_inches='tight')
