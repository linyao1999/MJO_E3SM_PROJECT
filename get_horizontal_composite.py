...
geop = ds1['FLNT'].sel(lat=slice(-lat_lim,lat_lim)).resample(time='1D').mean().load()
...
with open(dirn+'analysis/olr_composite_'+case_dir+'_latavg_Tlow'+str(Tlow)+'days.json', 'wb') as file:
